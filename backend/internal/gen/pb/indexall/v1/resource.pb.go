...
const file_indexall_v1_resource_proto_rawDesc = "" +
	"\n" +
	"\x1aindexall/v1/resource.proto\x12\vindexall.v1\"V\n" +
	...
	"\x12MATCH_SOURCE_ALIAS\x10\x042\xd0\x05\n" +
	"\x0fResourceService\x12Q\n" +
	"\x06Create\x12\".indexall.v1.CreateResourceRequest\x1a#.indexall.v1.CreateResourceResponse\x12Q\n" +
	"\x06Update\x12\".indexall.v1.UpdateResourceRequest\x1a#.indexall.v1.UpdateResourceResponse\x12Q\n" +
	"\x06Delete\x12\".indexall.v1.DeleteResourceRequest\x1a#.indexall.v1.DeleteResourceResponse\x12H\n" +
	"\x03Get\x12\x1f.indexall.v1.GetResourceRequest\x1a .indexall.v1.GetResourceResponse\x12M\n" +
	"\x04List\x12!.indexall.v1.ListResourcesRequest\x1a\".indexall.v1.ListResourcesResponse\x12S\n" +
	"\x06Search\x12#.indexall.v1.SearchResourcesRequest\x1a$.indexall.v1.SearchResourcesResponse\x12G\n" +
	"\bGetByUrl\x12\x1c.indexall.v1.GetByUrlRequest\x1a\x1d.indexall.v1.GetByUrlResponse\x12A\n" +
	"\x06AddTag\x12\x1a.indexall.v1.AddTagRequest\x1a\x1b.indexall.v1.AddTagResponse\x12J\n" +
	"\tRemoveTag\x12\x1d.indexall.v1.RemoveTagRequest\x1a\x1e.indexall.v1.RemoveTagResponseBFZDgithub.com/construct/indexall/internal/gen/pb/indexall/v1;indexallv1b\x06proto3"
