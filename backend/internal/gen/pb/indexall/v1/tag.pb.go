...
const file_indexall_v1_tag_proto_rawDesc = "" +
	"\n" +
	"\x15indexall/v1/tag.proto\x12\vindexall.v1\"\xec\x01\n" +
	"\x03Tag\x12\x0e\n" +
	...
	"\n" +
	"TagService\x12G\n" +
	"\x06Create\x12\x1d.indexall.v1.CreateTagRequest\x1a\x1e.indexall.v1.CreateTagResponse\x12G\n" +
	"\x06Update\x12\x1d.indexall.v1.UpdateTagRequest\x1a\x1e.indexall.v1.UpdateTagResponse\x12G\n" +
	"\x06Delete\x12\x1d.indexall.v1.DeleteTagRequest\x1a\x1e.indexall.v1.DeleteTagResponse\x12C\n" +
	"\x04List\x12\x1c.indexall.v1.ListTagsRequest\x1a\x1d.indexall.v1.ListTagsResponse\x12D\n" +
	"\aGetTree\x12\x1b.indexall.v1.GetTreeRequest\x1a\x1c.indexall.v1.GetTreeResponse\x12I\n" +
	"\x06Search\x12\x1e.indexall.v1.SearchTagsRequest\x1a\x1f.indexall.v1.SearchTagsResponse\x12G\n" +
	"\bAddAlias\x12\x1c.indexall.v1.AddAliasRequest\x1a\x1d.indexall.v1.AddAliasResponse\x12P\n" +
	"\vRemoveAlias\x12\x1f.indexall.v1.RemoveAliasRequest\x1a .indexall.v1.RemoveAliasResponse\x12J\n" +
	"\tAddParent\x12\x1d.indexall.v1.AddParentRequest\x1a\x1e.indexall.v1.AddParentResponse\x12S\n" +
	"\fRemoveParent\x12 .indexall.v1.RemoveParentRequest\x1a!.indexall.v1.RemoveParentResponseBFZDgithub.com/construct/indexall/internal/gen/pb/indexall/v1;indexallv1b\x06proto3"
