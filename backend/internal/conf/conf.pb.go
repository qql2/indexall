...
const file_conf_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"conf.proto\x12\vindexall.v1\x1a\x1egoogle/protobuf/duration.proto\"_\n" +
	"\tBootstrap\x12+\n" +
	"\x06server\x18\x01 \x01(\v2\x13.indexall.v1.ServerR\x06server\x12%\n" +
	"\x04data\x18\x02 \x01(\v2\x11.indexall.v1.DataR\x04data\"\xba\x02\n" +
	"\x06Server\x12,\n" +
	"\x04http\x18\x01 \x01(\v2\x18.indexall.v1.Server.HTTPR\x04http\x12,\n" +
	"\x04grpc\x18\x02 \x01(\v2\x18.indexall.v1.Server.GRPCR\x04grpc\x1ai\n" +
	"\x04HTTP\x12\x18\n" +
	...
	"\x04Data\x126\n" +
	"\bdatabase\x18\x01 \x01(\v2\x1a.indexall.v1.Data.DatabaseR\bdatabase\x1a:\n" +
	"\bDatabase\x12\x16\n" +
	"\x06driver\x18\x01 \x01(\tR\x06driver\x12\x16\n" +
	"\x06source\x18\x02 \x01(\tR\x06sourceB2Z0github.com/construct/indexall/internal/conf;confb\x06proto3"
...
var file_conf_proto_goTypes = []any{
	(*Bootstrap)(nil),           // 0: indexall.v1.Bootstrap
	(*Server)(nil),              // 1: indexall.v1.Server
	(*Data)(nil),                // 2: indexall.v1.Data
	(*Server_HTTP)(nil),         // 3: indexall.v1.Server.HTTP
	(*Server_GRPC)(nil),         // 4: indexall.v1.Server.GRPC
	(*Data_Database)(nil),       // 5: indexall.v1.Data.Database
	(*durationpb.Duration)(nil), // 6: google.protobuf.Duration
}
var file_conf_proto_depIdxs = []int32{
	1, // 0: indexall.v1.Bootstrap.server:type_name -> indexall.v1.Server
	2, // 1: indexall.v1.Bootstrap.data:type_name -> indexall.v1.Data
	3, // 2: indexall.v1.Server.http:type_name -> indexall.v1.Server.HTTP
	4, // 3: indexall.v1.Server.grpc:type_name -> indexall.v1.Server.GRPC
	5, // 4: indexall.v1.Data.database:type_name -> indexall.v1.Data.Database
	6, // 5: indexall.v1.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	6, // 6: indexall.v1.Server.GRPC.timeout:type_name -> google.protobuf.Duration
